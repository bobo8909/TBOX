...
void N720Init(void)
{
	...
	if(g_N720InitTIMFlag.bits.bN720StartInitFlag == 1)
	{
		...
		//USART_Send_String(ATCommandBuf[COMMAND_AT]);
	...
	{
		USART_Send_String(ATCommandBuf[COMMAND_ATI]);
